...
public:
    ...
    //DEBUGcout<< "\033[00;35m readq.size() : " << readq.size() <<"\033[00m" << endl;
    //DEBUGcout << "\033[00;36m writeq.size() : \033[00m" << writeq.size() << endl;
    //DEBUGcout << "\033[00;34m pending.size() : \033[00m" << pending.size() << endl;
    ...
    //DEBUGcout << "!write_mode is: " << !write_mode << endl;
        if (!write_mode) {
            // yes -- write queue is almost full or read queue is empty
            if (writeq.size() > int(wr_high_watermark * writeq.max) || readq.size() == 0)
                write_mode = true;
    //DEBUGcout << "!write_mode after is: " << !write_mode << endl;
        }
        else {
    ...
    //DEBUGcout << "is_valid_req - actq: " << is_valid_req << endl;
    //DEBUGcout << "actq.size(), otherq.size(), readq,size(), writeq.size() is: " << actq.size() << ", " << otherq.size() << ", " << readq.size() << ", " << writeq.size() << endl;
    ...
    //DEBUGcout << "is_valid_req - after 2nd get_head: " << is_valid_req << endl;
    ...
    //DEBUGcout << "is_valid_req - after is_ready() " << is_valid_req << endl;
